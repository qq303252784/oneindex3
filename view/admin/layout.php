...
<head>
	...
	<link rel="stylesheet" href="https://lib.baomitu.com/mdui/0.4.1/css/mdui.min.css" integrity="sha256-lCFxSSYsY5OMx6y8gp8/j6NVngvBh3ulMtrf4SX5Z5A=" crossorigin="anonymous">
	<script src="https://lib.baomitu.com/mdui/0.4.1/js/mdui.min.js" integrity="sha256-dZxrLDxoyEQADIAGrWhPtWqjDFvZZBigzArprSzkKgI=" crossorigin="anonymous"></script>
...
<!--    </a>-->
    ...
    <a href="https://alphaone-my.sharepoint.cn//" class="mdui-list-item" target="_blank">
      <i class="mdui-list-item-icon mdui-icon material-icons">&#xe2bf;</i>
